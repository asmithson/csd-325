...
while True:  # Main game loop.
    ...
    if roll_total in (2, 7):
        bonus = 10
        print(f"You rolled a {roll_total} and earned a {bonus} mon bonus!") # Corrected bonus message for flexibility in the future.
        purse += bonus
    ...
    if playerWon:
        ...
        house_fee = pot * 0.12 # Calculating the house fee at 12%.
        print('The house collects a', pot * 0.12, 'mon fee.') # Changed back to reflect 12% properly.
        purse = purse - house_fee # The house fee is now 12% from 10 mon.
    else:
